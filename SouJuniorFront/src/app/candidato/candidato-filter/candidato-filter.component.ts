...
@Component({
  selector: 'app-candidato-filter',
  templateUrl: './candidato-filter.component.html',
  styleUrls: ['./candidato-filter.component.scss']
})
export class CandidatoFilterComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private propostaService: PropostaService, private location: Location,
    ...
    columnsToDisplay = ['imagemPerfil','nomeEstudante','titulo','dataCriacao','isAceita', 'actions'];
